...
exports.unfreezePartner = void 0;
...
exports.unfreezePartner = (0, https_1.onCall)(async (request) => {
    ...
    if (partner.financialStatus !== 'frozen') {
        throw errors_1.Errors.preconditionFailed('השותף אינו מוקפא פיננסית');
    }
...
//# sourceMappingURL=unfreezePartner.js.map